...
const Login = () => {
  ...
  return (
    <div className={adminLogin === 'user-type' ? 'flex flex-col items-center w-full' : 'justify-center items-center w-full flex flex-col'}>
      {adminLogin === 'user-type' ? (
        <div className="w-[60%] mt-6 border bg-red-300 border-red-600 rounded-lg h-8 flex items-center px-4">
          Please Select type of user to login
        </div>
      ) : null}
      <div className={adminLogin === 'user-type' ? 'mt-7 flex items-center gap-4 w-[60%]' : 'mt-7 flex items-center gap-4'}>
        ...
        <div className="flex items-center justify-center gap-2">
          <label
            ...
            className={
              adminLogin === 'user'
                ? `btn-primary w-32 h-12 text-2xl`
                : 'w-32 h-12 flex items-center justify-center text-lg cursor-pointer border border-[rgb(13,148,136)] rounded-lg text-neutral-800'
            }
          >
            User
          </label>
          <label
            ...
            className={
              adminLogin === 'admin'
                ? 'btn-primary w-48 h-12 text-2xl'
                : 'w-48 h-12 flex items-center justify-center text-lg cursor-pointer border border-[rgb(13,148,136)] rounded-lg text-neutral-800'
            }
          >
            Admin
          </label>
      ...
      <button className={adminLogin === 'user-type' ? 'hidden' : 'btn-primary my-5'} onClick={submit}>
